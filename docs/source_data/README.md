...
| `known_gene_attention_ranks.tsv` | TSV | Detailed preliminary known-gene attention audit across traits; used by the redesigned R Figure 7 known-gene audit panel. | `data/3krice/processed/gene_attention_known_gene_overlap_w010_test/known_gene_attention_ranks.tsv` |
