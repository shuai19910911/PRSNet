...
1. 围绕 GraphEncoder 做多 seed 复跑（至少 chr-neighbor vs prefix2048_random 各 3 个 seed）并引入更强外部 biological graph；当前单 seed 等边随机图不支持宣称染色体邻接图有稳定增益。
