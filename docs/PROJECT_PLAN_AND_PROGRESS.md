...
2. SNP-MLP 已完成 early stopping / 正则网格；下一步若继续 neural SNP baseline，应加入 class-balanced 或 ordinal loss，重点提高 macro-F1，而不是单纯追 validation loss。
