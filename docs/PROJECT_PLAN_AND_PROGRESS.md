...
1. 启动 random degree-matched graph 与不同 `max_snps_per_gene` 消融，继续对齐 top512 + trait_attention 最佳配置。
2. 增补 SNP-MLP baseline，作为 tree baseline 之外的纯神经 SNP 对照。
