...
1. 对 `chr_string_v12_min700_top20_fusion` 融合图补 seed43/44 bounded pilot；若仍无优势，则不要继续宣称 STRING/chr 融合图有稳定增益。
2. 若 fusion 多 seed 仍与 chr/random 接近，转向 Plant Reactome/KEGG pathway、co-expression atlas，或放宽 STRING 阈值/拓扑选择以提升前 2,048 genes 的外部 biological edges 覆盖。
